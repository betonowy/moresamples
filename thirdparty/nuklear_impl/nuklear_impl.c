...
// void nk_overview(struct nk_context *nk) { overview(nk); }

// void nk_style_conf(struct nk_context *nk) {
//     static struct nk_color table[NK_COLOR_COUNT] = {
//         [NK_COLOR_TEXT] = {175, 175, 175, 255},
//         [NK_COLOR_WINDOW] = {45, 45, 45, 255},
//         [NK_COLOR_HEADER] = {40, 40, 40, 255},
//         [NK_COLOR_BORDER] = {65, 65, 65, 255},
...
NK_API int nk_sdl_handle_event(SDL_Event *evt) {
    ...
    case SDL_EVENT_TEXT_INPUT: {
        nk_input_glyph(ctx, evt->text.text);
        return 1;
    }
